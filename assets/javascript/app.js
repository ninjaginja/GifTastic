window.onload = function() {
  ...
  function displayGif() {
    ...
    var queryURL = "https://api.giphy.com/v1/gifs/search?api_key=" + APIKey + "&q=" + tvShow + "&limit=10&lang=en";
  ...
  function toggleImage() {
    ...
    $("#search-button").on("click", function(event) {
      ...
      // Calling displayButtons which handles the processing of tvShows array
      displayButtons();
    });
